...
from schongo.utils import ProcThread
...
def onLoad():
    ...
    def ping(ctx, cmd, arg, *args):
        ...
        pt = ProcThread(shellCmd, ctx, None)
        pt.start()
    ...
    def tracert(ctx, cmd, arg, *args):
        ...
        if os.name == 'nt':
            ...
            process = subprocess.Popen(shellCmd, stdin=MODIFIED_subprocess.PIPE, stdout=MODIFIED_subprocess.PIPE,
                                       stderr=MODIFIED_subprocess.STDOUT)
