...
def stripPunctuation(str, exceptions=''):
    """Strips everything but letters and numbers from a string. If 'exceptions' is
     included as a string, any character in exceptions will be left as-is."""
...
def listify(list, useand=False):
    """Properly format out a list to a string, including separating
     commas and 'and' before the last value if useand set to true."""
