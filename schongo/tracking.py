"""
_tracking.py is a module, auto-loaded by the core,
to give Schongo the ability to keep track of people's
hosts and nick changes
"""
...
def init():
    logger.info("Initalising tracking system.")
